...
//is this where encrypting/hashing needs to be added? - hk
$sql="SELECT idUser,Role FROM $tbl_name WHERE UserName='$myusername' and UserPassword='$mypassword'";
...
$_SESSION['valid'] = 0;
$_SESSION['user'] = -1;
header('Refresh:2; url=/Javan/MainLogin.php');
